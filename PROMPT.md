...
- Consacrer un bullet au prix du pétrole ou du Bitcoin par simple habitude — ne les mentionner que si le mouvement est exceptionnel (record, franchissement psychologique majeur, variation extrême, événement qui les impacte directement). Un jour sans mouvement notable sur ces deux actifs, laisser leur place à une autre info **de marché** (voir règle suivante) plutôt que de meubler avec un chiffre de routine
- Combler l'espace libéré par une anecdote économique généraliste sans lien avec un actif coté ou un acteur du marché (ex. une récolte, une statistique sociétale). Le remplaçant doit rester une info de marché : une action, un résultat d'entreprise, une fusion/acquisition, un taux, un flux de capitaux. Si aucune info de marché solide n'est disponible pour combler la place, remettre le pétrole ou le Bitcoin même sans mouvement exceptionnel plutôt que de sortir du cadre des marchés — c'est le filet de sécurité
- Choisir une actualité d'entreprise trop pointue ou confidentielle pour un public généraliste (petite capitalisation inconnue du grand public, accord B2B entre sociétés spécialisées, détail technique de guidance sectorielle) — même quand la marque elle-même est connue, un détail trop dans le métier reste un sujet de niche (ex. une révision de marge financière liée à la cession d'une filiale). Privilégier les faits d'entreprise que le lecteur reconnaît et comprend immédiatement, sans avoir besoin de connaître le secteur : une très grande capitalisation, un produit grand public, une décision qui parle à tout le monde
